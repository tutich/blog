...
const TransformationForm = ({ action, data = null, userId, type, creditBalance, config = null }: TransformationFormProps) => {
    ...
    const [newTransformatiion, setNewTransformation] = useState<Transformations | null>(null);
    ...
    async function onSubmit(values: z.infer<typeof formSchema>) {
        ...
        if (data || image) {
            ...
            if (!imageData.secureURL) {
                console.error('secureURL is required but not provided.');
            ...
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
                ...
                <div className="flex flex-col gap-4">
                    <Button
                        ...
                        disabled={isTransforming || newTransformatiion === null}
